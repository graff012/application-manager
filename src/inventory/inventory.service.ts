...
export class InventoryService {
  ...
  async create(dto: CreateInventoryDto, imageUrls: string[], employeeId?: string) {
  ...
  async update(id: string, dto: UpdateInventoryDto, imageUrls?: string[], employeeId?: string) {
